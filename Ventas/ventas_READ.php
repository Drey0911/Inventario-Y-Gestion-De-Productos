...
if (isset($_GET['success'])) {
    ...
    // redirigir a la pagina sin guardar ya el success 
...
<body class="container mt-5">
    ...
    <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 3): ?>
        <a href="ventas_CREATE.php" class="btn btn-success btn-sm">Añadir Nueva Venta<a>
            <?php endif; ?>
    ...
    <table id="ventasTable" class="table table-bordered table-striped">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 3): ?>
                <td>
                    <a href="ventas_UPDATE.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                    <a href="ventas_DELETE.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de borrar esta venta?')">Eliminar</a>
                </td>
                <?php endif; ?>
            </tr>
        <?php endwhile; ?>
