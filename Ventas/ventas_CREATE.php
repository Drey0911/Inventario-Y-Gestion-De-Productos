...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($cantidad <= 0 || $id_cliente == "" || $id_producto == "") {
        ...
        if ($producto['stock'] < $cantidad) {
            $error = "Error: No hay suficiente stock para realizar la venta. Stock disponible: " . $producto['stock'];
        } else {
            ...
            if ($stmt_insert->execute()) {
                ...
                $error = "Error al añadir la venta: " . $conn->error;
            }
        }
    }
}
...
<head>
    ...
    <title>Creación de Ventas</title>
    <script>
...
<header>
    <br>
<h1 class="text-center">Añadir Nueva Venta</h1>
</header>
<div class="mb-3">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-10 col-sm-12"> <!-- tamaño -->
                ...
                <?php if ($error): ?>
                    ...
                    <button type="submit" class="btn btn-success btn-block">Añadir Venta</button>
                </form>
            </div>
        </div>
    </div>
