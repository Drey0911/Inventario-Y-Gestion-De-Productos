...
<body class="container mt-5">
    <div class="mb-3">
        <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 5): ?>
            <a href="clientes_CREATE.php" class="btn btn-success btn-sm">Añadir Nuevo Cliente</a>
        <?php endif; ?>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 5): ?>
                        <td>
                            <a href="clientes_UPDATE.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                            <a href="clientes_DELETE.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de borrar este cliente?')">Borrar</a>
                        </td>
                    <?php endif; ?>
                </tr>
            <?php endwhile; ?>
