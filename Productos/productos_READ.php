...
<body class="container mt-5">
    ...
    <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 5): ?>
        <a href="productos_CREATE.php" class="btn btn-success btn-sm">Añadir Nuevo Producto<a>
            <?php endif; ?>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 5): ?>
                    <td>
                        <a href="productos_UPDATE.php?id=<?php echo $row['id']; ?> " class="btn btn-warning btn-sm">Editar<a>
                                <a href="productos_DELETE.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estas seguro de borrar este producto?')">Borrar<a>
                    </td>
                    <?php endif; ?>
                </tr>
            <?php endwhile; ?>
