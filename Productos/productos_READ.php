...
if (isset($_GET['success'])) {
    switch ($_GET['success']) {
        ...
        case 2:
            ...
            break;
        case 3:
            $alerta = "Producto borrado con éxito";
            $tipo_alerta = "success";
            break;
    }
...
<body class="min-h-screen text-gray-100 bg-gray-900">
        ...
        <div class="sidebar w-64 bg-gray-800 shadow-lg flex flex-col">
            ...
            <div class="flex-1 overflow-y-auto py-4">
                <nav class="space-y-1 px-4">
                    ...
                    <a href="../productos/productos_READ.php" class="sidebar-link flex items-center px-4 py-3 text-white bg-gray-700 rounded-lg active-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div>
                <h1 class="text-2xl sm:text-3xl font-bold gradient-text">Gestión de Productos</h1>
                <p class="text-gray-400">Listado completo de productos del sistema</p>
            </div>
            <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 5): ?>
            <a href="productos_CREATE.php" class="btn-action flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 w-full sm:w-auto justify-center">
        ...
        <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
            <div class="p-4 sm:p-6">
                <table id="productosTable" class="w-full display responsive nowrap" style="width:100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="flex flex-wrap gap-2">
                                    <a href="productos_UPDATE.php?id=<?php echo $row['id']; ?>" 
            ...
            $.ajax({
                ...
                success: function(response) {
                    if (response.success) {
                        ...
                        $('#productosTable').DataTable().row($('a[onclick="confirmDelete(' + productoId + ')"]').closest('tr')).remove().draw();
                    } else {
                        Swal.fire({
                            icon: 'error',
                            title: 'Error',
