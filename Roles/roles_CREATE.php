...
$sql_verificar = "SELECT * FROM roles WHERE (nombre = ?)";
...
if ($resultado_verificacion->num_rows > 0) {
    ...
    if ($row['nombre'] == $nombre) {
        $alerta= "Error: Este Rol ya existe en la base de datos.<br>";
    }
} else {
    ...
    if ($stmt->execute()) {
        header('Location: roles_READ.php?success=1');
        exit(); 
    } else {
...
<header>
    <br>
    <h1 class="text-center">Añadir Nuevo Rol</h1>
</header>
<div class="mb-3">
...
<?php endif; ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="descripcion" name="descripcion" placeholder ="Ingrese La Descripcion (Opcional)">
                    </div>
