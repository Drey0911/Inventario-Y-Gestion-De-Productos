...
if (isset($_GET['success'])) {
    switch ($_GET['success']) {
        ...
        case 3:
            ...
            break;
        case 4:
            $alerta = "El Rol no se puede borrar, El rol se encuentra en uso por uno o mas usuarios";
            $tipo_alerta = "danger";
            break;
    }
...
<body class="container mt-5">
    ...
    <?php if ($id_rol == 1 || $id_rol == 2): ?>
        <a href="roles_CREATE.php" class="btn btn-success btn-sm">Añadir Nuevo Rol<a>
            <?php endif; ?>
        ...
        <tbody>
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    ...
                    <?php if ($id_rol == 1 || $id_rol == 2): ?>
                    <td>
                        <a href="roles_UPDATE.php?id=<?php echo $row['id']; ?> " class="btn btn-warning btn-sm">Editar<a>
                                <a href="roles_DELETE.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estas seguro de borrar este rol?')">Borrar<a>
                    </td>
                    <?php endif; ?>
                </tr>
            <?php endwhile; ?>
