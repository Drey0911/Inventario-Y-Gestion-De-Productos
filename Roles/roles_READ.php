...
if (isset($_GET['success'])) {
    switch ($_GET['success']) {
        case 1:
            $alerta = "Rol creado con éxito";
            $tipo_alerta = "success";
            break;
        case 2:
            $alerta = "Rol actualizado con éxito";
            $tipo_alerta = "success";
            break;
        case 3:
            $alerta = "Rol borrado con éxito";
            $tipo_alerta = "success";
            break;
        case 4:
            $alerta = "El Rol no se puede borrar, está en uso por uno o más usuarios";
            $tipo_alerta = "error";
            break;
    }
...
if ($id_rol === 2){
    $sql = "SELECT * FROM roles WHERE estado = 1 AND id != 1";
    $result = $conn->query($sql);  
}
?>
            ...
            <div class="flex-1 overflow-y-auto py-4">
                <nav class="space-y-1 px-4">
                    ...
                    <?php if ($id_rol == 1 || $id_rol == 2): ?>
                        <a href="../roles/roles_READ.php" class="sidebar-link flex items-center px-4 py-3 text-white bg-gray-700 rounded-lg active-link">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        ...
                        <a href="../logout.php" class="text-xs text-gray-400 hover:text-purple-400">Cerrar sesión</a>
                                        ...
                                        <div class="flex-1 overflow-y-auto">
                                            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                                                    ...
                                                    <div>
                                                        <h1 class="text-2xl sm:text-3xl font-bold gradient-text">Gestión de Roles</h1>
                                                        <p class="text-gray-400">Listado completo de roles del sistema</p>
                                                    </div>
                                                    <?php if ($id_rol == 1 || $id_rol == 2): ?>
                                                    <a href="roles_CREATE.php" class="btn-action flex items-center px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 w-full sm:w-auto justify-center">
                            ...
                            <div class="bg-gray-800 rounded-xl shadow-lg overflow-hidden">
                                <div class="p-4 sm:p-6">
                                    <table id="rolesTable" class="w-full display responsive nowrap" style="width:100%">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="flex flex-wrap gap-2">
                                                        <a href="roles_UPDATE.php?id=<?php echo $row['id']; ?>" 
                                                        ...
                                                        <a href="roles_DELETE.php?id=<?php echo $row['id']; ?>" 
        ...
        $(document).ready(function() {
            $('#rolesTable').DataTable({
                ...
                initComplete: function() {
                    // Aplicar clases dark a los elementos de DataTables
