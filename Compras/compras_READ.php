...
<body class="container mt-5">
    ...
    <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 4): ?>
        <a href="compras_CREATE.php" class="btn btn-success btn-sm">Añadir Nueva Compra<a>
            <?php endif; ?>
    ...
    <table id="comprasTable" class="table table-bordered table-striped">
        ...
        <?php while ($row = $result->fetch_assoc()): ?>
            <tr>
                ...
                <?php if ($id_rol == 1 || $id_rol == 2 || $id_rol == 4): ?>
                <td>
                    <a href="compras_UPDATE.php?id=<?php echo $row['id']; ?>" class="btn btn-warning btn-sm">Editar</a>
                    <a href="compras_DELETE.php?id=<?php echo $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('¿Estás seguro de borrar esta compra?')">Eliminar</a>
                </td>
                <?php endif; ?>
            </tr>
        <?php endwhile; ?>
